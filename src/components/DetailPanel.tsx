...
export function DetailPanel({
	...
	return (
		<div
			ref={panelRef}
			className={["detail-panel", dragging ? "detail-panel--dragging" : "", isOpen ? "detail-panel--open" : ""]
				.filter(Boolean)
				.join(" ")}
		...
		>
			...
			<button className="detail-panel__close" onClick={onDismiss} aria-label="Close">
				×
			</button>
				...
				{entry && (
					<>
						...
						<div className="detail-panel__badges">
							<span className="detail-panel__badge detail-panel__badge--duration">
