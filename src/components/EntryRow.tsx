...
export type EntryRowProps = { entries: Entry[]; onSelect: (entry: Entry) => void };

export function EntryRow({ ariaAttributes, index, style, entries, onSelect }: RowComponentProps<EntryRowProps>) {
